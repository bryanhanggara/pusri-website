   ...
   <!-- Navbar -->
          ...
          <section class="list p-5">
            <div class="text-center">
                <span class="badge rounded-pill text-bg-secondary text-center pe-4 ps-4 pt-2 pb-2">BERITA</span>
            </div>
            ...
            <div class="content mt-5">
                <div class="image-container">
                    <img src="{{ asset('storage/'. $news->image) }}" alt="img_agenda" class="img-fluid">
                </div>
                <p class="mt-4">
                  <span class="fw-bold">{{ explode(' ', $news->description)[0] }}</span> 
                  {{ implode(' ', array_slice(explode(' ', $news->description), 1)) }}
                </p>
            </div>
